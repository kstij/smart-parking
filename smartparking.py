...
while 1:
  ...
  if (slot3_status == False):
   lcd_string("Slot3 Parked  ",LCD_LINE_1)
   mqttc.publish("slot3","1")
   time.sleep(0.2)
  else:
    lcd_string("Slot3 Free  ",LCD_LINE_1)
    mqttc.publish("slot3","0")
    time.sleep(0.2)
      
  if (slot4_status == True):
   lcd_string("Slot4 Parked  ",LCD_LINE_2)
   mqttc.publish("slot4","1")
   time.sleep(0.2)
  else:
      
    lcd_string("Slot4 Free  ",LCD_LINE_2)
